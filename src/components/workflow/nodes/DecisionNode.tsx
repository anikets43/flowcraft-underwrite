    ...
    <div className="min-w-[280px]">
      ...
      <Card className={`bg-workflow-node-bg border-2 shadow-node transition-all ${
        ...
        <div className="p-4">
          <div className="flex items-start justify-between mb-3">
            <div className="flex items-center gap-2">
              <div className="p-2 rounded-lg bg-workflow-danger/10">
                <GitBranch className="w-4 h-4 text-workflow-danger" />
              </div>
          ...
          {isEditing ? (
            <div className="space-y-3">
              ...
              <Textarea
                ...
                className="text-sm resize-none"
                rows={2}
                placeholder="Decision condition (e.g., age > 18 AND credit_score > 700)"
              />
            ...
            <div className="space-y-2">
              ...
              {data.condition && (
                <div className="mt-2 p-2 bg-workflow-danger-bg rounded text-xs text-workflow-danger font-mono">
                  {data.condition}
                </div>
              )}
            </div>
          ...
          <div className="mt-4 pt-3 border-t border-workflow-node-border">
